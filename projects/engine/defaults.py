...
from projects.engine.hooks import EvalHookFsdet
from projects.evaluation import (
    DatasetEvaluator,
    inference_on_dataset,
    print_csv_format,
    verify_results,
)
from projects.sparsercnn import build_model
from projects.utils.file_io import PathManager
...
def default_setup(cfg, args):
    ...
    setup_logger(output_dir, distributed_rank=rank, name="projects")
